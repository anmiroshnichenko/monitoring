...
**Ответ:**
- CPU LA - покажет загрузку  ЦПУ и необходимость  масштабировать платформу
- FS, inodes - покажет может ли еще платформа записывать данные на диски  и нужно ли масштабировать платформу
...
**Ответ:** 
- развернуть open-source  продукт Sentry  и мониторить ошибок в приложениях 
...
**Ответ:** 
Плюсы push:
- простота репликации данных в разные системы мониторинга
- более гибкая настройка отправки пакетов данных с метриками
- UDP — это менее затратный способ передачи данных, более высокая  производительность сбора метри
